...
#define G_LED               PORTBbits.RB3//LATBbits.LATB3      // Illuminates when RB3 goes low. Use WPU on this pin
#define G_LED_TRIS          TRISBbits.TRISB3

#define TEST_BUTTON         PORTBbits.RB4
#define TEST_BUTTON_TRIS    TRISBbits.TRISB4
...
#define _T3_45s             (15*45)//(100*45)
#define _T3_25s             (15*25)//(100*25)
#define _T3_10s             (15*10)//(100*10)
#define _T3_2s              (15*2)//(100*2)
#define _T3_1s              (15*1)//(100*1)
#define _T3_100ms           1//(10)
//#define _T3_10ms            (1)
 ...
 * VARIABLES
 ****************************************************/
const uint8_t VERSION[]= "2020";                   // Translates to version 2.00
