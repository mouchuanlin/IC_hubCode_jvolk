 ...
 * Author: Scott
 *
 * Created on October 16, 2018, 5:01 PM
 */
...
#define MD_PWR_TRIS         TRISAbits.TRISA3
...
#define DISABLE_MODEM()     MD_PWR=PWR_OFF
...
#define T3_25S              25      // based on t3 1s count
#define T3_1S               4       // based on 250ms timer
 ...
 * VARYABLES
 ****************************************************/
uint8_t gled_tmr0_tick, bled_tmr0_tick;
uint16_t tmr3_cnt = 0;
uint8_t _25sTmr3Cnt = 0, _1sTmr3Cnt = 0;
