...
//    reload_tmr5_pt25s();
    md_uart_write_str_ok((uint8_t *)&at[0], sizeof(at), YES, NO);
    md_uart_write_str_ok((uint8_t *)&ate[0], sizeof(ate), YES, NO);
    md_uart_write_str_ok((uint8_t *)&cmee[0], sizeof(cmee), YES, NO);
    md_uart_write_str_ok((uint8_t *)&baud[0], sizeof(baud), YES, NO);
    md_uart_write_str_ok((uint8_t *)&ledCfg[0], sizeof(ledCfg), YES, NO);
    md_uart_write_str_ok((uint8_t *)&ledpattern[0], sizeof(ledpattern), YES, NO);
    md_uart_write_str_ok((uint8_t *)&queryVersion[0], sizeof(queryVersion), YES, NO);
    md_uart_write_str_ok((uint8_t *)&cpin[0], sizeof(cpin), YES, NO);
    md_uart_write_str_ok((uint8_t *)&creg[0], sizeof(creg), YES, NO);
    md_uart_write_str_ok((uint8_t *)&cereg[0], sizeof(cereg), YES, NO);
    md_uart_write_str_ok((uint8_t *)&gprs[0], sizeof(gprs), YES, NO);
    md_uart_write_str_ok((uint8_t *)&csq[0], sizeof(csq), YES, NO);
    terminate_md_uart();
